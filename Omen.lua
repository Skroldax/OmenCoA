	...
	profile = {
		...
		Bar = {
			...
			Classes = {
				...
				PET = true, PRIEST = true, ROGUE = true, SHAMAN = true, WARLOCK = true,
				WARRIOR = true, HERO = true, ["*NOTINPARTY*"] = true,
				NECROMANCER = true, PYROMANCER = true, CULTIST = true, STARCALLER = true,
				SUNCLERIC = true, SUN_CLERIC = true, TINKER = true, RUNEMASTER = true,
				PRIMALIST = true, REAPER = true, VENOMANCER = true, CHRONOMANCER = true,
				BLOODMAGE = true, BLOOD_MAGE = true, GUARDIAN = true, STORMBRINGER = true,
				FELSWORN = true, BARBARIAN = true, WITCHDOCTOR = true, WITCH_DOCTOR = true,
				WITCHHUNTER = true, WITCH_HUNTER = true, KNIGHTOFXOROTH = true, KNIGHT_OF_XOROTH = true,
...
local showClassesOptionTable = {
	DEATHKNIGHT = L["DEATHKNIGHT"], DRUID = L["DRUID"], HUNTER = L["HUNTER"],
	MAGE = L["MAGE"], PALADIN = L["PALADIN"], PET = L["PET"], PRIEST = L["PRIEST"],
	ROGUE = L["ROGUE"], SHAMAN = L["SHAMAN"], WARLOCK = L["WARLOCK"],
	WARRIOR = L["WARRIOR"], HERO = L["HERO"], ["*NOTINPARTY*"] = L["*Not in Party*"],
	NECROMANCER = "Necromancer", PYROMANCER = "Pyromancer", CULTIST = "Cultist", STARCALLER = "Starcaller",
	SUNCLERIC = "Sun Cleric", SUN_CLERIC = "Sun Cleric", TINKER = "Tinker", RUNEMASTER = "Runemaster",
	PRIMALIST = "Primalist", REAPER = "Reaper", VENOMANCER = "Venomancer", CHRONOMANCER = "Chronomancer",
	BLOODMAGE = "Bloodmage", BLOOD_MAGE = "Bloodmage", GUARDIAN = "Guardian", STORMBRINGER = "Stormbringer",
	FELSWORN = "Felsworn", BARBARIAN = "Barbarian", WITCHDOCTOR = "Witch Doctor", WITCH_DOCTOR = "Witch Doctor",
	WITCHHUNTER = "Witch Hunter", WITCH_HUNTER = "Witch Hunter", KNIGHTOFXOROTH = "Knight of Xoroth", KNIGHT_OF_XOROTH = "Knight of Xoroth",
...
function Omen:UpdateBarsReal()
	...
	for j = 1, #sortTable do
		...
		local show
		if class == nil then
			show = dbBar.Classes["*NOTINPARTY*"]
		elseif class == "AGGRO" then
			show = dbBar.ShowAggroBar
		else
			show = dbBar.Classes[class]
