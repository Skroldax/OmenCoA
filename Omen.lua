...
if RAID_CLASS_COLORS then
	for k, _ in pairs(RAID_CLASS_COLORS) do
		defaults.profile.Bar.Classes[k] = true
	end
end
...
if RAID_CLASS_COLORS then
	local customClassNames = {
		NECROMANCER = "Necromancer",
		PYROMANCER = "Pyromancer",
		CULTIST = "Cultist",
		STARCALLER = "Starcaller",
		SUNCLERIC = "Sun Cleric", SUN_CLERIC = "Sun Cleric",
		TINKER = "Tinker",
		...
		BLOODMAGE = "Bloodmage", BLOOD_MAGE = "Bloodmage",
		GUARDIAN = "Guardian",
		STORMBRINGER = "Stormbringer",
		FELSWORN = "Felsworn",
		BARBARIAN = "Barbarian",
		WITCHDOCTOR = "Witch Doctor", WITCH_DOCTOR = "Witch Doctor",
		WITCHHUNTER = "Witch Hunter", WITCH_HUNTER = "Witch Hunter",
		KNIGHTOFXOROTH = "Knight of Xoroth", KNIGHT_OF_XOROTH = "Knight of Xoroth",
		TEMPLAR = "Templar",
		RANGER = "Ranger"
	}
	for k, _ in pairs(RAID_CLASS_COLORS) do
		if not showClassesOptionTable[k] then
			showClassesOptionTable[k] = customClassNames[k] or (k:sub(1,1):upper() .. k:sub(2):lower())
		end
	end
end
